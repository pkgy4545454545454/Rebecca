...
const hasRealPhoto = (enterprise) => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="home-page">
      ...
      <section className="relative h-screen overflow-hidden pt-0" data-testid="hero-section">
   ...
   {/* Category Buttons - 2 rows */}
     ...
     <div className="flex justify-center gap-2 min-w-[106px] mt-1 w-[100%] bout">
      ...
      {premium.length > 0 && (
        <section className="py-8 sm:py-16 bg-pink-100" data-testid="premium-section">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="flex items-center justify-between mb-6 sm:mb-8">
              <div>
                <h2 className="text-lg sm:text-2xl md:text-3xl font-semibold text-gray-900">
                 Vidéos Premium <span className="text-[#dc3545]">X </span>
                </h2>
              </div>
      ...
      <section className="py-12 sm:py-20 md:py-28 bg-[pink]" data-testid="cta-section">
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            <Link to="/about" className="border-2 border-black text-white text-sm sm:text-lg px-6 sm:px-10 py-3 sm:py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors">
              En savoir plus
            </Link>
          </div>
        </div>
